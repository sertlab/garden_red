...
var User          = require('../app/models/gardener');
require('datejs') 
    ...
    function(req, email, password, done) {
        ...
        process.nextTick(function() {
            ...
            if (password.length < 6)
                return done(null, false, req.flash('signupMessage', 'Password must be 6 characters long'));
             if (req.body.username.length < 3)
                return done(null, false, req.flash('signupMessage', 'Username must be 3 characters long'));
